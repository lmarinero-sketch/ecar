...
export const TUTORIAL_CONTENT: Record<ModuleId, TutorialEntry> = {
  ...
  wbs: {
    title: 'WBS — Planificación de Obra (Gerencia de Obras)',
    description: 'Work Breakdown Structure. Descomposición jerárquica del trabajo por obra, control de estado (Activa/Pausada/Finalizada), cronograma Gantt y rendimientos diarios.',
    steps: [
      'Seleccioná el proyecto/obra a planificar en el portfolio de obras.',
      'Controlá el estado de la obra en la cabecera: podés cambiar entre Activa 🟢, Pausada 🟡 o Finalizada 🏁 en 1 clic.',
      'Planificá tareas por cuadrilla con el catálogo estándar, asignando múltiples maquinarias si es necesario.',
      'Generá e imprimí la Orden de Trabajo Impresa (OTI en PDF) a las 07:00 para el capataz.',
      'Revisá los desvíos operativos en la pestaña "Desvíos & Acciones".',
    ],
    tips: [
      'Para marcar una obra como terminada, usá el desplegable "Estado" en la cabecera del proyecto.',
      'Podés editar cualquier tarea creada con el botón ✏️ o eliminarla con 🗑️ si hubo error de tipeo.',
      'El WBS se puede vincular con el visor 3D para visualización del avance físico.',
    ],
  },
  field: {
    title: 'Parte Diario & Control de Rendimientos',
    description: 'Registro diario oficial de actividades de obra, control de cuadrillas, rendimientos por hora y paradas operativas.',
    steps: [
      'Creá un nuevo parte diario seleccionando la obra y fecha.',
      'Usá el botón "⚡ Precargar Tareas de Hoy" para volcar en 1 clic las actividades planificadas sin tener que escribirlas a mano.',
      'En la pestaña "Personal", usá "⚡ Copiar Cuadrilla Anterior" para cargar a todos los operarios del día previo en 1 solo clic con sus 8 hs.',
      'En la pestaña "Equipos" o en "Rendimientos & Tareas", asigná múltiples vehículos/maquinarias mediante etiquetas interactivas.',
      'Si hubo paradas por falta de material o insumos, generá el pedido urgente a compras/pañol directamente desde la tarjeta de parada.',
    ],
    tips: [
      'No vuelvas a tipear las tareas: el botón de precarga jala automáticamente las descripciones y paradas de la jornada.',
      'Podés rectificar cualquier dato de escritura o medición usando el botón ✏️ Editar Tarea.',
    ],
  },
  safety: {
