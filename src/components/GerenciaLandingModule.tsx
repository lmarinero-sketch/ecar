...
const GERENCIA_DATA: Record<GerenciaKey, GerenciaConfig> = {
  ...
  logistics: {
    ...
    icon: Warehouse,
    overview: 'La Gerencia de Logística custodia el stock en Pañol central y depósitos de obra, gestiona la trazabilidad tripartita de pedidos (Obra ➔ Pañol ➔ Recepción) con descuento automático de stock, auditoría completa en Kardex (quién, cuándo y a qué obra), emisión de PDFs oficiales ECAR (Solicitud, Remito y Acta de Recepción), y la administración de flota vehicular con GPS y partes diarios por QR.',
    flowSteps: [
      { step: '1', title: 'Solicitud de Pedido (Obra)', desc: 'Requisición de materiales desde la obra o vía WhatsApp con Rombo. Genera PDF Solicitud.', role: 'Obra / Capataz', icon: PackageCheck, color: 'bg-sky-100 text-sky-700' },
      { step: '2', title: 'Despacho & Descuento Stock', desc: 'Pañol declara las cantidades enviadas. El sistema descuenta stock automáticamente.', role: 'Pañolero Central', icon: Layers, color: 'bg-blue-100 text-blue-700' },
      { step: '3', title: 'Auditoría Kardex & Derivación', desc: 'Registra egreso con fecha, hora, responsable y pedido. Saldos faltantes pasan a Compras.', role: 'Logística', icon: Truck, color: 'bg-indigo-100 text-indigo-700' },
      { step: '4', title: 'Recepción & Conformidad Obra', desc: 'Recepción en campo con verificación física, observaciones y firma de Acta PDF.', role: 'Receptor de Obra', icon: CheckCircle2, color: 'bg-emerald-100 text-emerald-700' },
      { step: '5', title: 'Flota, Mantenimiento & QR', desc: 'Escaneo de QR vehicular, carga de Km, validez VTV, combustible y talleres.', role: 'Chofer / Taller', icon: Wrench, color: 'bg-purple-100 text-purple-700' },
    ],
    tools: [
      { id: 'purchase_requests', title: 'Pedidos de Obra & Requerimientos', desc: 'Trazabilidad tripartita (Solicitado vs Enviado vs Recibido), despacho y PDFs ECAR.', icon: Package, gradient: 'from-amber-600 to-orange-600' },
      ...
      { id: 'inventory', title: 'Inventario & Pañol (Kardex)', desc: 'Stock físico, descuento automático, auditoría Kardex (quién/cuándo) y reposición.', icon: Package, gradient: 'from-slate-700 to-slate-900' },
    ],
    deliverables: [
      { area: 'A Gerencia de Obra', icon: Building2, color: 'bg-amber-50 border-amber-200 text-amber-900', items: ['Materiales despachados a tiempo con remito firmado', 'Remitos PDF y Actas de Recepción con conformidad', 'Maquinaria asignada con parte diario al día'] },
      { area: 'A Gerencia de Compras', icon: ShoppingCart, color: 'bg-blue-50 border-blue-200 text-blue-900', items: ['Saldos faltantes de pedidos derivados automáticamente', 'Alertas de stock mínimo para reposición preventiva', 'Reporte de calidad de herramientas recibidas'] },
      { area: 'A Adm. y Finanzas', icon: Landmark, color: 'bg-emerald-50 border-emerald-200 text-emerald-900', items: ['Kardex auditado de movimientos con responsable, fecha y hora', 'Rendición de cargas de combustible y peajes', 'Inventario valorizado anual/mensual'] },
    ],
    faq: [
      { question: '¿Cómo funciona la trazabilidad tripartita de pedidos?', answer: 'Obra solicita materiales, Pañol declara lo despachado y Obra confirma la recepción. El sistema compara automáticamente las 3 cantidades para detectar faltantes.' },
      { question: '¿Cómo se descuenta el stock del Pañol?', answer: 'El descuento de stock es 100% automático al momento en que Pañol confirma el despacho en la pantalla de Pedidos. Se actualiza el inventario y se audita la salida en el Kardex.' },
      { question: '¿Quién queda registrado en los movimientos de Kardex?', answer: 'Cada movimiento guarda la fecha, hora exacta, nombre del pañolero responsable, obra de destino y código de pedido (PED-XXXX).' },
      { question: '¿Cómo se descargan los PDFs oficiales ECAR?', answer: 'Desde cada tarjeta de pedido podés hacer clic en "PDF Solicitud", "PDF Remito" o "PDF Acta Recepción". Todos vienen con estética institucional ECAR y firmas.' },
    ]
  },
