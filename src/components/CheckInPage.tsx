        ...
        {status === 'error' && (
          <div className="max-w-sm w-full mt-4">
            <div className="bg-white/5 backdrop-blur-xl border border-red-500/30 rounded-2xl p-8 text-center space-y-4 shadow-2xl">
              ...
              <h2 className="text-xl font-bold text-white">QR Inválido</h2>
              <p className="text-slate-300 text-sm leading-relaxed">{error}</p>
              <div className="bg-amber-500/10 rounded-xl p-3 border border-amber-500/20">
                <p className="text-xs text-amber-300 font-medium">⏱ Los códigos QR se renuevan cada 10 minutos</p>
              </div>
            </div>
          </div>
        )}
        ...
        {status === 'select_employee' && (
          <div className="max-w-sm w-full space-y-4">
            <div className="text-center space-y-2 mb-2">
              <div className="w-14 h-14 mx-auto rounded-full bg-emerald-500/20 flex items-center justify-center border border-emerald-500/30">
                <ShieldCheck size={28} className="text-emerald-400" />
              </div>
              <h2 className="text-xl font-bold text-white">QR Verificado ✓</h2>
              <p className="text-slate-400 text-sm">Seleccioná tu nombre para fichar</p>
            </div>
